...
import BrowserHistorySlider from "./sliders/BrowserHistorySlider";
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-5">
            ...
            <div className="flex items-center space-x-2">
              <button
                type="button"
                className="browser-history-slider-next size-8 shrink-0 bg-white flex items-center justify-center rounded-full border border-gray-200 shadow-md p-2">
              ...
              <button
                type="button"
                className="browser-history-slider-prev size-8 shrink-0 bg-white flex items-center justify-center rounded-full border border-gray-200 shadow-md p-2">
