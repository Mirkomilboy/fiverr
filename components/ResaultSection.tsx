...
export const Resault = () => {
  ...
  const currentItems = CardsData.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE);
    ...
    <section className="max-w-8xl mx-auto px-4 lg:px-8 my-4">
      ...
      <div className="flex justify-center gap-4 mt-20">
        <button
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#74767E">
        ...
        <div className="flex space-x-2">
          {Array.from({ length: totalPages }, (_, index) => (
            <button
              ...
              className={`px-4 py-2 rounded-full w-10 h-10 ${
                currentPage === index + 1
                  ? "bg-brand-slate-100 text-brand-black-100"
                  : "bg-transparent text-brand-gray-dark"
              }`}>
              {index + 1}
            </button>
          ))}
